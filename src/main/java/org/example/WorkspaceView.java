...
//
//        // 2. The equation editor panel (Left Bar)
//        // CHANGED: Upgraded to handle the boolean 'isFast' flag from the panel
//        DraggableEquationPanel overlay = new DraggableEquationPanel((list, isFast) -> {
//            if (isFast) {
//                graph.setEquationsFast(list);
//            } else {
//                graph.setEquations(list);
//            }
//        });
//
//        // 3. Back Button
